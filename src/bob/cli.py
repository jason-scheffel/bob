...
research_app = typer.Typer(
    no_args_is_help=True,
    add_completion=False,
    help="Offline quote-sim research (named strategies: s1–s23).",
)
...
_register_research_strategy(
    s19,
    docstring="s19: matched-horizon excursion-reclaim current-bracket hold (quote-sim).",
    minutes_help="Comma-separated checkpoint minutes (31..59).",
    has_abstentions=True,
)
_register_research_strategy(
    s20,
    docstring="s20: walk-forward path-analog continuation vote (quote-sim).",
    minutes_help="Comma-separated checkpoint minutes (30..59).",
    has_abstentions=True,
)
_register_research_strategy(
    s21,
    docstring="s21: residual-range lock current-bracket hold (quote-sim).",
    minutes_help="Comma-separated checkpoint minutes (2..59).",
    has_abstentions=True,
)
_register_research_strategy(
    s22,
    docstring="s22: asymmetric dual-buffer residual-range hold (quote-sim).",
    minutes_help="Comma-separated checkpoint minutes (2..59).",
    has_abstentions=True,
)
_register_research_strategy(
    s23,
    docstring="s23: aged unfinished sojourn-drawdown hold (quote-sim).",
    minutes_help="Comma-separated checkpoint minutes (15..59).",
    has_abstentions=True,
)
...
def research_all(
    ...
    workers: Annotated[
        int | None,
        typer.Option(help="Process pool size (default: min(23, CPUs))."),
    ] = None,
) -> None:
    """Run s1–s23 quote-sim in parallel; one table per checkpoint minute."""
    require_gate()
    minute_list = _research_common_options(db, start, end, minutes)
