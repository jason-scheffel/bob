...
The code is licensed under the GNU Affero General Public License v3.0 or later. See [LICENSE](LICENSE) for the full text. Documentation and other prose, including this README, is under [CC BY-SA 4.0](LICENSES/CC-BY-SA-4.0.txt). Config files are under [CC0 1.0](LICENSES/CC0-1.0.txt).
